...
def dibujar_logo_64(p, b64_string, x, y, ancho):
    """Dibuja un logo desde base64 en el PDF. Recibe el canvas 'p' como parámetro."""
    try:
...
def generar_pdf(datos, imagen_firma):
    ...
    # --- DIBUJAR LOGOS ---
    dibujar_logo_64(p, logo_campofert_64, 50, 610, 80)
    dibujar_logo_64(p, logo_campolab_64, 480, 610, 80)
