...
def generar_pdf(datos, imagen_firma):
    ...
    logo_campolab_64 = """data:image/png;base64,""" # <--- Y AQUÍ
        ...
        # --- FUNCIÓN PARA CONVERTIR EL TEXTO EN IMAGEN (VERSIÓN CORREGIDA) ---
    def dibujar_logo_64(b64_string, x, y, ancho):
        try:
            ...
            # Convertir a RGB si tiene transparencia (evita que salga negro o invisible)
            if img_pil.mode in ("RGBA", "P"):
                img_pil = img_pil.convert("RGB")
            
            # Dibujar sin el parámetro mask para evitar errores de capa
            p.drawImage(ImageReader(img_pil), x, y, width=ancho, preserveAspectRatio=True)
            
        except Exception as e:
            st.error(f"Error técnico en logo: {e}")

    # --- DIBUJAR LOS LOGOS ---
    dibujar_logo_64(logo_campofert_64, 50, 680, 80)
    dibujar_logo_64(logo_campolab_64, 480, 680, 80)

    # --- TÍTULOS ---
    p.setFont("Helvetica-Bold", 16)
    p.drawCentredString(width/2, 650, "CERTIFICADO DE ASISTENCIA")
    ...
    if imagen_firma is not None:
        try:
            ...
            p.drawImage(ImageReader(img_f), 100, 152, width=150, height=60, mask='auto')
        except:
            pass
